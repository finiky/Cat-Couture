...
describe("ProductPage", () => {
  ...
  test("WHEN a user goes to the Products page, THEN the current page will be highlighted in the pagination control", () => {
    ...
    // 'highlight' is the aria-label for mark HTML element used to highlight the current page number on the website"
    const highlightedText = screen.getByLabelText("highlight").textContent;
